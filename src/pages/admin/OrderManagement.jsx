...
const OrderManagement = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {Object.entries({
          total: { label: 'Total Orders', value: orders.length, color: 'bg-blue-500', icon: Package },
          ...
          revenue: { label: 'Total Revenue', value: `₹${orders.reduce((sum, order) => sum + (order.totalAmount || 0), 0).toLocaleString()}`, color: 'bg-purple-500', icon: Truck }
        }).map(([key, stat]) => (
