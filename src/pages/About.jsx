  ...
  const timeline = [
    {
      year: '2020',
      title: 'The Dawn',
      description: 'A simple idea born in a family dairy farm: fresh milk should never travel far. Rajesh, our founder, started delivering to 10 neighbors.',
    ...
    },
    {
      year: '2021',
      title: 'First Steps',
      description: '100 families trusted us. We formalized our promise: same-day delivery, farm-fresh quality. The community grew organically.',
    ...
    },
    {
      year: '2022',
      title: 'Growing Roots',
      description: 'Expanded to artisanal cheeses and yogurt. Partnered with 15 local farms. Won "Best Local Producer" award.',
    ...
    },
    {
      ...
      description: '5000 families. Developed our temperature-controlled delivery system. Featured in "Food & Farm" magazine.',
    ...
    {
      year: '2024',
      title: 'The Chapter Today',
      description: 'Serving 50,000+ families across 3 cities. Every delivery still carries that first-day passion. Our journey continues.',
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="space-y-8">
              ...
              <p className="text-2xl text-gray-300 leading-relaxed max-w-3xl mx-auto font-light">
                We're a legacy of passion, purity, and purpose. From farm to family, we deliver 
                not just fresh dairy, but trust and tradition.
              </p>
            </motion.div>
